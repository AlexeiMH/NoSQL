...
export default {
    ...
    data() {
        return {
            ...
            username: 'SiriusW',
            madeForYou: [
                { title: '', artists: 'Ado, Mrs. GREEN APPLE...', color: '#008080' },
                { title: '', artists: 'LiSA, Creepy Nuts...', color: '#cd5c5c' },
                { title: '', artists: 'Cartel De Santa, Babo...', color: '#b22222' },
            ],
            recent: [
                { title: 'Sonido contemporáneo', subtitle: '', color: '#4682b4' },
                { title: 'A mega Anime hits mix!', subtitle: '', color: '#2e8b57' },
                { title: 'Arcane Official Playlist', subtitle: 'Every legend has a beginning.', color: '#1e3a4c', image: 'https://i.scdn.co/image/ab67706f00000002891f7a68555095b871c8b356' },
            ]
        };
    },
    computed: {
    ...
    methods: {
        ...
        logout() {
            ...
            // Aquí iría la lógica real de logout (limpiar token, redirigir, etc.)
...
#spotify-clone {
    display: grid;
    grid-template-areas: 'sidebar main-view' 'player-bar player-bar';
...
/* === ESTADO COLAPSADO === */
#spotify-clone.sidebar-collapsed {
    grid-template-columns: var(--sidebar-width-collapsed) 1fr;
}

#spotify-clone.sidebar-collapsed .library-title-text {
    display: none;
}

#spotify-clone.sidebar-collapsed .library-title-button {
    justify-content: center;
    padding: 12px 0;
}

#spotify-clone.sidebar-collapsed .library-content {
    opacity: 0;
    pointer-events: none;
}
...
.search-active-view:focus-within {
    border-color: #fff;
}
...
/* Estilos para la lista de items (usado en ambas búsquedas) */
.item-list-container {
    list-style: none;
    padding: 0;
    margin: 0;
...
/* === ESTILOS PARA EL MENÚ DE USUARIO (AÑADIDO) === */
.user-menu-container {
    position: relative;
    margin-left: auto;
    /* Empuja el menú al final del header */
}
